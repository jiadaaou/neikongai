<template>
  <div class="law-detail">
    ...
    >
      <el-alert
        title="⚠️ 编辑后将自动重新向量化，请确保法律条文的准确性！"
        type="warning"
        :closable="false"
        show-icon
...
const editChunk = (chunk) => {
  ElMessageBox.confirm(
    '编辑分块内容后将自动重新向量化。<br/><strong style="color: red;">请谨慎修改，确保法律条文的准确性！</strong>',
    '⚠️ 编辑警告',
    {
