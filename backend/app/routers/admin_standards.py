"""
管理员标准文档路由
提供标准文档的上传、管理、查询等 API
"""

from fastapi import APIRouter, UploadFile, File, Form, Depends, HTTPException, BackgroundTasks
from app.core.database import get_db_connection
from app.services.document_processor_standards import doc_processor as standards_doc_processor
...
# 文件上传目录
UPLOAD_DIR = "/var/www/neikongai/uploads/standards"
...
async def process_document_task(document_id: int, file_path: str):
    ...
    try:
        ...
        # 调用处理器
        result = await standards_doc_processor.process_document(document_id, file_path)
